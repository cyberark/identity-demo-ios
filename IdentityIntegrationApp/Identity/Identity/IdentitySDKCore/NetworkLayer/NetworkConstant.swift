...
import Foundation
/*
/// Handles all the pointing urls like develpoment,production etc.
 */
public struct APIRequestConstants {
    static let ciamDevURL = ""
    static let ciamProductionURL = ""
    static let ciamInternalDevURL = ""
}
...
/// Tells about the specified errors when API request made.
///
/// - invalidJSONData: invalid json data
/// - dataParseError: json parse error
/// - noData: when there is no data
...
/// - acceptContentType: <#acceptContentType description#>
/// - contentDisposition: <#contentDisposition description#>
enum HttpHeaderKeys:String {
    ...
    func getValue() -> String{
        ...
        case .authorization:
            value = ""
        case .contenttype,.acceptContentType:
            value = "application/json"
        case .contentDisposition:
            value = ""
        case .applicationfomrurlencoded:
